		<style type="text/css">
			...
			*/
			...
			#demoDiv{
				...
				background-image:-moz-linear-gradient(top, #fff 0%, rgba(255, 255, 255, 0) 2%);
				background-image:-ms-linear-gradient(top, #fff 0%, rgba(255, 255, 255, 0) 2%);
				background-image:-o-linear-gradient(top, #fff 0%, rgba(255, 255, 255, 0) 2%);
...
/**/
				...
				var myGrid = new Grid(
															"demoGrid"
															, {
																		srcType : "dom",								// データ形式 ["dom"]or["json"]or["xml"]
																		srcData : "demoTable",					// 対象テーブルID
																		allowGridResize : true,					// 不明
																		allowColumnResize : false,			// 列のリサイズ				
																		allowClientSideSorting : false,	// ソート機能
																		allowSelections : false,				// 列選択
																		allowMultipleSelections : true, // true：チェック or false：ラジオ
																		showSelectionColumn : true,			// チェック列
